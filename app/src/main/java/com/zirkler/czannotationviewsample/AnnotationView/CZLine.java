...
/**
 * CZLine is defined by starting point and ending point on 2D dimension.<br>
 *
 */
public class CZLine
{
    private final CZPoint _start;
    private final CZPoint _end;
    private float _a = Float.NaN;
    private float _b = Float.NaN;
    private boolean _vertical = false;

    public CZLine(CZPoint start, CZPoint end)
    {
        _start = start;
        _end = end;
     ...
     */
    public boolean isInside(CZPoint point)
    {
